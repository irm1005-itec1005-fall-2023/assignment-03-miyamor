...
function clearCompletedTasks() {
  ...
  addToDoItem("Cleaning the toilet");  // test for adding tasks 
  addToDoItem("Vacuum the floor");
  addToDoItem("Wash the dishes");
  addToDoItem("Wash the cars");
  addToDoItem("Wash the face");
  addToDoItem("Wash the body");
  addToDoItem("Wash the dog");
